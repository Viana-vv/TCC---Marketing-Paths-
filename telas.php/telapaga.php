  ...
  <div style="display:flex;">
    <div class="left-guide">
      ...
      <a href="pdf.php" class="left-guide-container">
        <i class="bi bi-file-earmark-pdf" style="color:red; font-size:2vw;"></i>
      </a>
      ...
      <a href="tutorial.php" class="tutorial">
        <div>
          ...
          <p>Este bloco serve para orientar o usuário sobre como utilizar os cursos e entender a estrutura do site.
            Ele pode conter instruções passo a passo, dicas de navegação e exemplos práticos para facilitar o
            aprendizado.</p>
        </div>
      </a>

      <a href="" class="areaCursos">
        <div>
